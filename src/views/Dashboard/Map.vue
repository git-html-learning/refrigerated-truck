...
watch: {
  ...
  methods: {
    ...
    async getPk() {
      console.log(window.sessionStorage.getItem("productKey"))
      if (window.sessionStorage.getItem("productKey") !== null) {
        this.iconShow = true
      } 
...
this.markers.push(obj);
   ...
   item.lng = "117.191753"
    ...
    lookDetail(data) {
      ...
      this.typeIdentify = data.typeIdentify
    },
    // 关闭弹窗
    infoWindowClose() {
      this.showFlag = false;
...
//     },
     trans() {
      ...
      window.sessionStorage.setItem("carNum",this.transName)
      window.sessionStorage.setItem("typeIdentify",this.typeIdentify)
